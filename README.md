...
- **Data Interpolation Calculator** — fit data points using four interpolation methods: Linear, Polynomial (Lagrange), Polynomial (Newton), and Cubic Spline. Evaluate the interpolated function at any x, visualize the interpolation curve with data points annotated. Interactive demo on the project landing page. Available on desktop (Python), Android (Java), and web landing page interactive demo.
